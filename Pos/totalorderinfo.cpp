...
TotalOrderInfo::TotalOrderInfo():order_date(""),menu_name(""),menu_price(0),amount(0),tot_menu_price(0)
{}

char* TotalOrderInfo::get_order_date()
{
    return order_date;
}
...
int TotalOrderInfo::get_status() const
{
    return status;
}
...
void TotalOrderInfo::set_status(int status)
{
    this->status = status;
}
